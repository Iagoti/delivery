package com.iago.delivery.tracking.domain.model;

import com.iago.delivery.tracking.domain.event.DeliveryFulfilledEvent;
import com.iago.delivery.tracking.domain.event.DeliveryPickUpEvent;
import com.iago.delivery.tracking.domain.event.DeliveryPlacedEvent;
import com.iago.delivery.tracking.domain.exception.DomainException;
...
public class Delivery extends AbstractAggregateRoot<Delivery> {
    ...
    private void verifyIfCanBePlaced() {
        if (!isFilled()) {
            throw new DomainException("Erro em verifyIfCanBePlaced");
        }
    ...
    private void verifyIfCanBeEdited() {
        if (!getStatus().equals(DeliveryStatus.DRAFT)) {
            throw new DomainException("Erro em verifyIfCanBeEdited");
        }
    }
