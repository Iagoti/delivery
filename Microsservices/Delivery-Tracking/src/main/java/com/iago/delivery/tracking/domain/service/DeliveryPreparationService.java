...
import com.iago.delivery.tracking.api.model.ContactPointInput;
import com.iago.delivery.tracking.api.model.DeliveryInput;
import com.iago.delivery.tracking.api.model.ItemInput;
...
public class DeliveryPreparationService {
    ...
    public Delivery edit(UUID deliveryId, DeliveryInput input) {
        Delivery delivery = deliveryRepository.findById(deliveryId)
                .orElseThrow(() -> new DomainException("Erro em edit"));
